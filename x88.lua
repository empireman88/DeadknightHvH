...
local upd_sel = gui.Combobox(upd_gbox_sel, "x88.upd.sel", "Tab Chooser", "Updater", "Change-Log", "News")
...
local news_groupbox = gui.Groupbox(x88_updtab, "News", 15, 125, 600, 0)
...
local news_text = gui.Text(news_groupbox, http.Get("https://raw.githubusercontent.com/w1ldac3/x88Cheats-UI-Lua/master/news.txt"))
...
local x88_con = gui.Groupbox(x88_tab,"Contact Information", 15,450,294,400)
